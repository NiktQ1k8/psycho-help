...
export const therapists = [
  ...
  },
  {
    ...
    consult_areas:
      'Семейные отношения, супружеские конфликты, детско-родительские отношения',
    description:
...
export const news = [
  // Эти 4 новости специально для комиссии, они строго по макету, не трогать, иначе комиссия будет недовольна и поставит 2 за проект
  {
    ...
    title:
      'Психологи университета приглашают на ПСИХОparty в честь Дня психолога',
...
<p>🍪 Не забудь взять с собой вкусняшки!</p>`,
  },
  {
    ...
    title:
      'В университете успешно прошел праздник ПСИХОparty с арт-практиками и чаепитием',
